...
const { updateProfessional,deleteProfessional,getProfessional,getAllVerifiedProfessionals,getAllRejectedProfessionals,getAllPendingforApproval_Professionals,getAllProfessionals,updateDocumentAccess, getAlldocuments, getDocument, getDocumentPatients, create_prescription} = require('../controllers/professional');
...
router.get("/create_prescription", verifyUser, create_prescription);
